  ...
  return (
    <div className="w-full mx-auto">
      <div className="md-w-[92%] md:h-2/3 h-[491px] -mt-10 mx-auto overflow-hidden">
        <h1 className="relative md:top-[123px] md:left-[80px] left-[90px] top-[110px] text-4xl text-myWhite font-montserrat">
          All Products
        </h1>
        <Image
          ...
          width={1440}
          height={209}
          className="lg:w-[1440px] lg:h-[209px] h-[146px] lg:mx-auto"
        />
      </div>
      ...
      <div className="mx-auto md:my-8 my-0 w-[92%] grid grid-cols-2 md:grid-cols-4 md:gap-4 gap-3">
        {/* firt row */}
