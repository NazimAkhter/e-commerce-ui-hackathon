      ...
      <div className="md:w-[92%] w-full my-5 bg-darkPrimary md:my-[60px] mx-auto flex flex-col md:flex-row justify-between">
        <div className="md:h-auto h-full md:w-1/2 ">
          ...
          my-auto md:h-4/5 w-[92%] md:w-4/5 mx-auto">
            ...
            <div className="scale-90 md:ml-0 -ml-2 md:scale-100 text-darkPrimary bg-myWhite hover:bg-gray-200 active:scale-95 active:bg-gray-400 cursor-pointer ">
              <Link href="/Product">
                <Button title="View collection" />
              </Link>
            </div> 
            <h2 className="text-myWhite text-[17px] md:py-0 py-9 font-normal md:tracking-normal tracking-wide font-montserrat ">
